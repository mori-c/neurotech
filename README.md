...
3. [Introduction to Neuroscience](#03)  ﹊  <sup>04/2/19</sup>
...
7. [EEG Oscillatory Processes](#07) ⋯ [⿻](https://github.com/mori-c/uoft-neurotech/blob/master/2019/workshop_2018_2019/notes/Workshop6.pdf) ﹊  <sup>11/3/19</sup> 
...
8. [AngularJS, Offline Data](#08) ﹊ <sup>18/3/19</sup>
* AngularJS
~~* Advanced Git~~
* Offline (dataset) 
* Work session
...
### <a name="03">Neuroscience Introduction</a>
...
### <a name="07">EEG Oscillatory Processes</a>
